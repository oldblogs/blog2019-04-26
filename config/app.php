...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Route name for App API
    |--------------------------------------------------------------------------
    */
    'mapi' => env('APP_MAPI', 'manage'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Maximum amount of page link buttons a pagination will use.
    |
    */
    ...
    */
    ...
    'media_per_page' => env('APP_MEDIA_PER_PAGE', 10),
    ...
    */
    ...
    'default_guard' => env('APP_DEFAULT_GUARD', 'web'),
